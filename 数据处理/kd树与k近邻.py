...
# 1. 读取人口密度数据
density_df = pd.read_csv("D:\文档\大学文件\竞赛\统计建模\真正的统模\数据\人口密度数据.csv")
...
# 3. 读取POI数据
poi_df = pd.read_csv("D:\文档\大学文件\竞赛\统计建模\真正的统模\数据\重庆POI数据.csv", encoding='utf-8')
poi_coords = poi_df[['投影X', '投影Y']].values
...
# 5. 保存结果
poi_df.to_csv("D:\文档\大学文件\竞赛\统计建模\真正的统模\数据\重庆POI数据_带人口密度.csv", index=False, encoding='utf-8-sig')
